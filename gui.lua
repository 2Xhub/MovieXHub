...
spawn(function() 
    ...
    wait(.3)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>Welcome To Movie X Hub<Color=/>"):Display()
    wait(.2)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Owner : ! MovieX<Color=/>"):Display()
    wait(.3)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Channel : LTDMC<Color=/>"):Display()
    wait(.4)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : https://discord.gg/R4xC3t2Xm8<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>! MovieX and T... and House Of Blance is the Best <Color=/>"):Display()
end)
...
local Window = OrionLib:MakeWindow({
    Name = "Movie X Hub", 
    HidePremium = false,
    IntroText = "Movie Library", 
    SaveConfig = true, 
    ConfigFolder = "Movie X Hub"
})
...
function Notify(Hiri, Mi)
    OrionLib:MakeNotification({
        Name = "[Movie X Hub]",
        Content = Hiri,
        Image = "rbxassetid://16876945310",
        Time = Mi
    })
end

local I = Window:MakeTab({Name = "Info", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local G = Window:MakeTab({Name = "General", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local ST = Window:MakeTab({Name = "Settings", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local IQ = Window:MakeTab({Name = "Item & Quest", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local LC = Window:MakeTab({Name = "LocalPlayer", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local RD = Window:MakeTab({Name = "Raid & Devil Fruit", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local SV = Window:MakeTab({Name = "Status and Servers", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local RC = Window:MakeTab({Name = "Upgrated Race", Icon = "rbxassetid://16876945310", PremiumOnly = false })
local SE = Window:MakeTab({Name = "Sea Event", Icon = "rbxassetid://16876945310", PremiumOnly = false })
...
I:AddLabel("Owner : Movie X Hub")
I:AddLabel("Best Brothers : ! Movie X New")
...
I:AddLabel("Use Gui Banana")
I:AddLabel("Taem Faker 🇻🇳")
...
local Moon = SV:AddLabel("Moon : Khong Full Moon")
